...
public class Attacker : MonoBehaviour
{
    ...
    [Header("Damage")]
    [SerializeField]
    private DamageData _damageData = new DamageData(10f, DamageType.Physical);
    ...
    void Attack()
    {
        if (ProjectilePrefab != null && Body != null)
        {
            ...
            projectile.GetComponent<AttackProjectile>().Configure(this, CurrentTarget, DamageData);
        }
        else
        {
            CurrentTarget.TakeDamage(this, DamageData);
        }
    }
